...
public class ProgressionActivity extends AppCompatActivity {
    ...
    private ArrayList<ProgressionItem> generateRepublicData(){
        ...
        planets.add(new ProgressionItem("Mandalorian Raiders", "Flashpoint", R.drawable.ic_flashpoint, "", TimelineType.LINE, ProgressionItem.ITEM));
        ...
        planets.add(new ProgressionItem("Balmorra", "Bonus Series 1", R.drawable.faction_both_black, "", TimelineType.LINE, ProgressionItem.ITEM));
        ...
        planets.add(new ProgressionItem("Voss", "Bonus Series 1", R.drawable.faction_both_black, "", TimelineType.LINE, ProgressionItem.ITEM));
        ...
        planets.add(new ProgressionItem("False Emperor", "Flashpoint", R.drawable.ic_flashpoint, "", TimelineType.LINE, ProgressionItem.ITEM));
        ...
        planets.add(new ProgressionItem("Makeb", "Level 53-55", R.drawable.pl_makeb, "", TimelineType.SINGLE, ProgressionItem.ITEM));
        ...
        planets.add(new ProgressionItem("Czerka Core Meltdown", "Flashpoint", R.drawable.faction_both_black, "", TimelineType.LINE, ProgressionItem.ITEM));
