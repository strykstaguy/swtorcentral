...
public class ProgressionActivity extends AppCompatActivity {
    ...
    private ArrayList<ProgressionItem> generateRepublicData(){
        ...
        planets.add(new ProgressionItem("Republic Fleet", "Level 10+", R.drawable.ic_republic_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Taris", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Tatooine", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        ...
        planets.add(new ProgressionItem("Nar Shaddaa", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        ...
        planets.add(new ProgressionItem("Balmorra", "Bonus Series 1", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Balmorra", "Bonus Series 2", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Alderaan", "Bonus Series", R.drawable.pl_alderaan, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Voss Bonus Series 1", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Voss Bonus Series 2", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Voss Bonus Series 3", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Hoth Bonus Series", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Belsavis", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        ...
        planets.add(new ProgressionItem("Makeb", "Level 53-55", R.drawable.pl_makeb, TimelineType.LINE, ProgressionItem.PLANET));

        planets.add(new ProgressionItem("Level 55 Content", ProgressionItem.SECTION));

        planets.add(new ProgressionItem("Oricon", "Flashpoint", R.drawable.pl_oricon, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("CZ-198", "Flashpoint", R.drawable.pl_cz198, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Czerka Corporate Labs", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Czerka Core Meltdown", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Kuat Drive Yards", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Assault on Tython", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Korriban Incursion", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Rakatta Prime", "Flashpoint", R.drawable.pl_rakata_prime, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Manaan", "Flashpoint", R.drawable.pl_manaan, TimelineType.LINE, ProgressionItem.FLASHOPR));
        planets.add(new ProgressionItem("Rishi", "Flashpoint", R.drawable.pl_rishi, TimelineType.LINE, ProgressionItem.FLASHOPL));
        planets.add(new ProgressionItem("Yavin IV", "Flashpoint", R.drawable.pl_yavin, TimelineType.LINE, ProgressionItem.FLASHOPR));
        return planets;
    }
