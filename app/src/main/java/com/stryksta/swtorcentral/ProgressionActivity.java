...
public class ProgressionActivity extends AppCompatActivity {
    ...
    private ArrayList<ProgressionItem> generateRepublicData(){
        ...
        planets.add(new ProgressionItem("Republic Fleet", "Level 10+", R.drawable.ic_republic_black, TimelineType.LINE, ProgressionItem.PLANET));

        planets.add(new ProgressionItem("The Esseles", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.FLASHOP));
        ...
        planets.add(new ProgressionItem("Nar Shaddaa", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Taral V", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Balmorra", "Level 32-36", R.drawable.pl_balmorra, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Balmorra", "Bonus Series 1", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Balmorra", "Bonus Series 2", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Maelstrom Prison", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.PLANET));
        ...
        planets.add(new ProgressionItem("Alderaan", "Bonus Series", R.drawable.pl_alderaan, TimelineType.LINE, ProgressionItem.PLANET));
        ...
        planets.add(new ProgressionItem("Voss Bonus Series 1", ProgressionItem.SECTION));
        planets.add(new ProgressionItem("Voss Bonus Series 2", ProgressionItem.SECTION));
        planets.add(new ProgressionItem("Voss Bonus Series 3", ProgressionItem.SECTION));
        planets.add(new ProgressionItem("Hoth Bonus Series", ProgressionItem.SECTION));
        ...
        planets.add(new ProgressionItem("Belsavis", "Bonus Series", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.PLANET));
        ...
        planets.add(new ProgressionItem("Lost Island", "Flashpoint", R.drawable.ic_flashpoint, TimelineType.LINE, ProgressionItem.PLANET));
        ...
        planets.add(new ProgressionItem("Korriban Incursion", "Flashpoint", R.drawable.faction_both_black, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Rakatta Prime", "Flashpoint", R.drawable.pl_rakata_prime, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Manaan", "Flashpoint", R.drawable.pl_manaan, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Rishi", "Flashpoint", R.drawable.pl_rishi, TimelineType.LINE, ProgressionItem.PLANET));
        planets.add(new ProgressionItem("Yavin IV", "Flashpoint", R.drawable.pl_yavin, TimelineType.LINE, ProgressionItem.PLANET));
        return planets;
    }
