...
public class TestActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ( FactionText.equals("Republic")) {
            factionAdapter = new TestAdapter(TestActivity.this, generateRepublicData());
        } else {
            factionAdapter = new TestAdapter(TestActivity.this, generateEmpireData());
        }

        HorizontalListView progressionList = (HorizontalListView) findViewById(R.id.testList);
