...
public class MaterialProgress extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.MaterialProgress_circleRadius, circleRadius);

        fillRadius = a.getBoolean(R.styleable.MaterialProgress_fillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.MaterialProgress_barWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.MaterialProgress_rimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.MaterialProgress_spinSpeed, spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.MaterialProgress_barSpinCycleTime, (int) barSpinCycleTime);

        barColor = a.getColor(R.styleable.MaterialProgress_barColor, barColor);

        rimColor = a.getColor(R.styleable.MaterialProgress_rimColor, rimColor);

        if (a.getBoolean(R.styleable.MaterialProgress_progressIndeterminate, false)) {
            spin();
        }
