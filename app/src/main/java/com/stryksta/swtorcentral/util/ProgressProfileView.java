...
public class ProgressProfileView extends ImageView {
    ...
    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        // Load attributes
        final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.ProgressProfileView, defStyleAttr, defStyleRes);

        setMax(a.getFloat(R.styleable.ProgressProfileView_max, mMax));
        setProgress(a.getFloat(R.styleable.ProgressProfileView_progress, mProgress));
        if (!a.hasValue(R.styleable.ProgressProfileView_backgroundRingSize)) {
            if (a.hasValue(R.styleable.ProgressProfileView_progressRingSize)) {
                setProgressRingSize(a.getDimension(R.styleable.ProgressProfileView_progressRingSize, mProgressRingSize));
                setBackgroundRingSize(mProgressRingSize);
            }
        } else {
            setBackgroundRingSize(a.getDimension(R.styleable.ProgressProfileView_backgroundRingSize, mBackgroundRingSize));
            setProgressRingSize(a.getDimension(R.styleable.ProgressProfileView_progressRingSize, mProgressRingSize));
        }
        setProgressRingOutline(a.getBoolean(R.styleable.ProgressProfileView_progressRingOutline, false));
        setBackgroundRingColor(a.getColor(R.styleable.ProgressProfileView_backgroundRingColor, mBackgroundRingColor));
        setProgressRingColor(a.getColor(R.styleable.ProgressProfileView_progressRingColor, mProgressRingColor));
        setProgressRingCap(a.getInt(R.styleable.ProgressProfileView_progressRingCap, Paint.Cap.BUTT.ordinal()));
