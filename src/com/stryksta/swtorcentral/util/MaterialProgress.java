...
public class MaterialProgress {
    ...
    private MaterialDialog mCustomAlertDialog;
    ...
    public MaterialProgress(Context context, int progressStyle,String title, boolean cancelable,
    ...
    private MaterialDialog get(Context context, String title,
        ...
        if (mProgressStyle == STYLE_HORIZONTAL) {
            view = inflater.inflate(R.layout.material_progress_hori, null);
        } else {
            view = inflater.inflate(R.layout.material_progress, null);
        }
    ...
    /**
     * Ã§â€�Å¸Ã¦Ë†ï¿½Ã¦Å’â€°Ã©â€™Â®
     * @param builder
     */
    private void createButtons(MaterialDialog.Builder builder){
    ...
    public MaterialProgress setPositiveButton(String text, DialogInterface.OnClickListener listener){
    ...
    public MaterialProgress setPositiveButton(int resId, DialogInterface.OnClickListener listener){
    ...
    public MaterialProgress setNegativeButton(String text, DialogInterface.OnClickListener listener){
    ...
    public MaterialProgress setNegativeButton(int resId, DialogInterface.OnClickListener listener){
    ...
    public MaterialProgress setNeutralButton(String text, DialogInterface.OnClickListener listener){
    ...
    public MaterialProgress setNeutralButton(int resId, DialogInterface.OnClickListener listener){
